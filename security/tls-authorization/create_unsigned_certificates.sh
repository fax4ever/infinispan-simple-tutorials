...
keytool -genkeypair -alias infinispan-server -keystore server-keystore.pfx -keyalg RSA -dname "CN=Server,OU=Infinispan,O=JBoss,L=Red Hat" -storepass secret -validity 365 -keysize 4096 -keypass my_secret_key
...
keytool -genkeypair -alias client1 -keystore client1-keystore.pfx -storepass Client1secret -dname "CN=Client1,OU=Infinispan,O=JBoss,L=Red Hat" -validity 365 -keyalg RSA -keysize 2048 -keypass my_secret_key
# Export the self-signed certificate
...
keytool -genkeypair -alias client2 -keystore client2-keystore.pfx -storepass Client2secret -dname "CN=Client2,OU=Infinispan,O=JBoss,L=Red Hat" -validity 365 -keyalg RSA -keysize 2048 -keypass my_secret_key
# Export the self-signed certificate
